...
このプロジェクトのソースコードおよび関連ファイルは、閲覧および改変を許可します。
ただし、再配布は一切禁止します。

- 閲覧 OK
- 改変 OK
- 公開・再配布・配布・転売・再アップロード NG
- そのままの形でも改変後の形でも、許可なく配布してはいけません

本プロジェクトの再配布を希望する場合は、事前に著作権者に明示的な許可を取得してください。
詳細な方針は `LICENSE` ファイルを参照してください。
